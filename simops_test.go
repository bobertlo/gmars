...
func TestDIV(t *testing.T) {
	tests := []redcodeTest{
		...
		},
		{
			...
			output:   []string{"div.f $1, $2", "dat.f #0, #3", "dat.f #6, #12"},
			pq:       []Address{},
			coresize: 256,
		},
		{
			input:    []string{"div.f $1, $2", "dat.f #2, #0", "dat.f #6, #12"},
			output:   []string{"div.f $1, $2", "dat.f #2, #0", "dat.f #6, #12"},
			pq:       []Address{},
			coresize: 256,
		},
		...
		},
		{
			...
			output:   []string{"div.i $1, $2", "dat.f #0, #3", "dat.f #6, #12"},
			pq:       []Address{},
			coresize: 256,
		},
		{
			input:    []string{"div.i $1, $2", "dat.f #2, #0", "dat.f #6, #12"},
			output:   []string{"div.i $1, $2", "dat.f #2, #0", "dat.f #6, #12"},
			pq:       []Address{},
			coresize: 256,
		},
		...
		},
		{
			...
			output:   []string{"div.x $1, $2", "dat.f #0, #3", "dat.f #6, #12"},
			pq:       []Address{},
			coresize: 256,
		},
		{
			input:    []string{"div.x $1, $2", "dat.f #2, #0", "dat.f #6, #12"},
			output:   []string{"div.x $1, $2", "dat.f #2, #0", "dat.f #6, #12"},
			pq:       []Address{},
			coresize: 256,
		},
	}
...
func TestMOD(t *testing.T) {
	tests := []redcodeTest{
		...
		},
		{
			...
			output:   []string{"mod.f $1, $2", "dat.f #3, #0", "dat.f #10, #15"},
			pq:       []Address{},
			coresize: 256,
		},
		{
			input:    []string{"mod.f $1, $2", "dat.f #0, #4", "dat.f #10, #15"},
			output:   []string{"mod.f $1, $2", "dat.f #0, #4", "dat.f #10, #15"},
			pq:       []Address{},
			coresize: 256,
		},
		...
		},
		{
			...
			output:   []string{"mod.i $1, $2", "dat.f #3, #0", "dat.f #10, #15"},
			pq:       []Address{},
			coresize: 256,
		},
		{
			input:    []string{"mod.i $1, $2", "dat.f #0, #4", "dat.f #10, #15"},
			output:   []string{"mod.i $1, $2", "dat.f #0, #4", "dat.f #10, #15"},
			pq:       []Address{},
			coresize: 256,
		},
		...
		},
		{
			...
			output:   []string{"mod.x $1, $2", "dat.f #3, #0", "dat.f #10, #15"},
			pq:       []Address{},
			coresize: 256,
		},
		{
			input:    []string{"mod.x $1, $2", "dat.f #0, #4", "dat.f #10, #15"},
			output:   []string{"mod.x $1, $2", "dat.f #0, #4", "dat.f #10, #15"},
			pq:       []Address{},
			coresize: 256,
		},
	}
